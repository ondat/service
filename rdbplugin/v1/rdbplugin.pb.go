...
func (m *RdbStatus) GetStatus() *DaemonStatus {
	if m != nil {
		return m.Status
	}
	return nil
...
func (m *RdbVolume) GetCc() *DataplaneCommon {
	if m != nil {
		return m.Cc
	}
	return nil
...
type RdbPluginClient interface {
	...
	//
	// returns RpcResult
	VolumeCreate(ctx context.Context, in *RdbVolume, opts ...grpc.CallOption) (*RpcResult, error)
	// *
	// Create a volume. Currently has no actual effect other than
	...
	//
	// returns RpcResult
	VolumeUpdate(ctx context.Context, in *RdbVolume, opts ...grpc.CallOption) (*RpcResult, error)
	// *
	...
	//
	// returns RpcResult
	VolumeDelete(ctx context.Context, in *RdbVolume, opts ...grpc.CallOption) (*RpcResult, error)
	// *
...
func (c *rdbPluginClient) VolumeCreate(ctx context.Context, in *RdbVolume, opts ...grpc.CallOption) (*RpcResult, error) {
	out := new(RpcResult)
...
func (c *rdbPluginClient) VolumeUpdate(ctx context.Context, in *RdbVolume, opts ...grpc.CallOption) (*RpcResult, error) {
	out := new(RpcResult)
...
func (c *rdbPluginClient) VolumeDelete(ctx context.Context, in *RdbVolume, opts ...grpc.CallOption) (*RpcResult, error) {
	out := new(RpcResult)
...
func (c *rdbPluginClient) ConfigGetBool(ctx context.Context, in *ConfigKey, opts ...grpc.CallOption) (*ConfigGetBoolReply, error) {
...
func (c *rdbPluginClient) ConfigUpdateBool(ctx context.Context, in *ConfigBool, opts ...grpc.CallOption) (*ConfigUpdateReply, error) {
...
func (c *rdbPluginClient) ConfigListBool(ctx context.Context, in *ConfigListQuery, opts ...grpc.CallOption) (*ConfigBoolList, error) {
...
func (c *rdbPluginClient) ConfigGetString(ctx context.Context, in *ConfigKey, opts ...grpc.CallOption) (*ConfigGetStringReply, error) {
...
func (c *rdbPluginClient) ConfigUpdateString(ctx context.Context, in *ConfigString, opts ...grpc.CallOption) (*ConfigUpdateReply, error) {
	out := new(ConfigUpdateReply)
...
func (c *rdbPluginClient) ConfigListString(ctx context.Context, in *ConfigListQuery, opts ...grpc.CallOption) (*ConfigStringList, error) {
...
type RdbPluginServer interface {
	...
	//
	// returns RpcResult
	VolumeCreate(context.Context, *RdbVolume) (*RpcResult, error)
	// *
	// Create a volume. Currently has no actual effect other than
	// to update the entry reporting that the volume is 'configured', and so will
	// have results returned by VolumeList.
	//
	// returns RpcResult
	VolumeUpdate(context.Context, *RdbVolume) (*RpcResult, error)
	// *
	// Delete the storage allocated for a volume.
	//
	// Deletion can take some time, this call starts the deletion process then
	...
	//
	// returns RpcResult
	VolumeDelete(context.Context, *RdbVolume) (*RpcResult, error)
	// *
	// Return a list of configured volumes. Optionally filter using the RdbVolumeListQuery message.
	//
	// returns An RdbVolumeList message containing RdbVolume messages,
...
func _RdbPlugin_ConfigGetBool_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RdbPluginServer).ConfigGetBool(ctx, req.(*ConfigKey))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _RdbPlugin_ConfigUpdateBool_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RdbPluginServer).ConfigUpdateBool(ctx, req.(*ConfigBool))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _RdbPlugin_ConfigListBool_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RdbPluginServer).ConfigListBool(ctx, req.(*ConfigListQuery))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _RdbPlugin_ConfigGetString_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RdbPluginServer).ConfigGetString(ctx, req.(*ConfigKey))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _RdbPlugin_ConfigUpdateString_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RdbPluginServer).ConfigUpdateString(ctx, req.(*ConfigString))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _RdbPlugin_ConfigListString_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RdbPluginServer).ConfigListString(ctx, req.(*ConfigListQuery))
	}
	return interceptor(ctx, in, info, handler)
}
