...
package v1 // import "code.storageos.net/storageos/service/stats/v1"
...
func (*StatsStatusRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_stats_6c6af6789f7744f6, []int{0}
}
...
func (dst *StatsStatusRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StatsStatusRequest.Merge(dst, src)
}
...
func (*StatsStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_stats_6c6af6789f7744f6, []int{1}
}
...
func (dst *StatsStatus) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StatsStatus.Merge(dst, src)
}
...
func (*StatsVolumeListQuery) Descriptor() ([]byte, []int) {
	return fileDescriptor_stats_6c6af6789f7744f6, []int{2}
}
...
func (dst *StatsVolumeListQuery) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StatsVolumeListQuery.Merge(dst, src)
}
...
func (*StatsVolumeLabel) Descriptor() ([]byte, []int) {
	return fileDescriptor_stats_6c6af6789f7744f6, []int{3}
}
...
func (dst *StatsVolumeLabel) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StatsVolumeLabel.Merge(dst, src)
}
...
func (*StatsVolumeCredentials) Descriptor() ([]byte, []int) {
	return fileDescriptor_stats_6c6af6789f7744f6, []int{4}
}
...
func (dst *StatsVolumeCredentials) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StatsVolumeCredentials.Merge(dst, src)
}
...
func (*StatsVolumeStatistics) Descriptor() ([]byte, []int) {
	return fileDescriptor_stats_6c6af6789f7744f6, []int{5}
}
...
func (dst *StatsVolumeStatistics) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StatsVolumeStatistics.Merge(dst, src)
}
...
func (*StatsVolumeStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_stats_6c6af6789f7744f6, []int{6}
}
...
func (dst *StatsVolumeStatus) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StatsVolumeStatus.Merge(dst, src)
}
...
func (*StatsVolume) Descriptor() ([]byte, []int) {
	return fileDescriptor_stats_6c6af6789f7744f6, []int{7}
}
...
func (dst *StatsVolume) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StatsVolume.Merge(dst, src)
}
...
func (*StatsVolumeList) Descriptor() ([]byte, []int) {
	return fileDescriptor_stats_6c6af6789f7744f6, []int{8}
}
...
func (dst *StatsVolumeList) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StatsVolumeList.Merge(dst, src)
}
...
func init() { proto.RegisterFile("stats.proto", fileDescriptor_stats_6c6af6789f7744f6) }

var fileDescriptor_stats_6c6af6789f7744f6 = []byte{
