...
class NodeConfiguration : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:dataplane.NodeConfiguration) */ {
 public:
  ...
  #if LANG_CXX11
  NodeConfiguration(NodeConfiguration&& from) noexcept
    : NodeConfiguration() {
    *this = ::std::move(from);
  }

  inline NodeConfiguration& operator=(NodeConfiguration&& from) noexcept {
  ...
  friend void swap(NodeConfiguration& a, NodeConfiguration& b) {
    a.Swap(&b);
  }
...
class PresentationSpec : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:dataplane.PresentationSpec) */ {
 public:
  ...
  #if LANG_CXX11
  PresentationSpec(PresentationSpec&& from) noexcept
    : PresentationSpec() {
    *this = ::std::move(from);
  }

  inline PresentationSpec& operator=(PresentationSpec&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  friend void swap(PresentationSpec& a, PresentationSpec& b) {
    a.Swap(&b);
  }
...
class VolumeSpec : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:dataplane.VolumeSpec) */ {
 public:
  ...
  #if LANG_CXX11
  VolumeSpec(VolumeSpec&& from) noexcept
    : VolumeSpec() {
    *this = ::std::move(from);
  }

  inline VolumeSpec& operator=(VolumeSpec&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  friend void swap(VolumeSpec& a, VolumeSpec& b) {
    a.Swap(&b);
  }
