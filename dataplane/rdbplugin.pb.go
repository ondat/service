...
type RdbPluginConfigClient interface {
	// *
	// Create a volume. Currently has no actual effect other authentication
...
func (c *rdbPluginConfigClient) VolumeCreate(ctx context.Context, in *RdbVolume, opts ...grpc.CallOption) (*storageos_rpc1.RpcResult, error) {
	out := new(storageos_rpc1.RpcResult)
	err := grpc.Invoke(ctx, "/storageos_rpc.RdbPluginConfig/VolumeCreate", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _RdbPluginConfig_VolumeCreate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RdbVolume)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RdbPluginConfigServer).VolumeCreate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/storageos_rpc.RdbPluginConfig/VolumeCreate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RdbPluginConfigServer).VolumeCreate(ctx, req.(*RdbVolume))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _RdbPluginConfig_VolumeCreate_Handler,
		},
		{
...
var fileDescriptor0 = []byte{
	...
	,
}
