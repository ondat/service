...
type FsPresentation struct {
	...
	// empty if the volume does not pertain to a snapshot
	ParentUuid string `protobuf:"bytes,10,opt,name=parent_uuid,json=parentUuid,proto3" json:"parent_uuid,omitempty"`
	// The snapshot ID if this volume is a snapshot. 0 if not.
	SnapshotId           uint32   `protobuf:"varint,11,opt,name=snapshot_id,json=snapshotId,proto3" json:"snapshot_id,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *FsPresentation) GetParentId() uint32 {
	if m != nil {
		return m.ParentId
	}
	return 0
...
func (m *FsPresentation) GetParentUuid() string {
	if m != nil {
		return m.ParentUuid
	}
	return ""
...
func (m *FsPresentation) GetSnapshotId() uint32 {
	if m != nil {
		return m.SnapshotId
	}
	return 0
...
var fileDescriptor_0a9f8093c6c7067e = []byte{
	...
	,
}
