...
type FsVolume struct {
	...
	// The volume ID of the parent volume if this volume pertains to a snapshot
	// 0 if the volume does not pertain to a snapshot
	ParentId uint32 `protobuf:"varint,11,opt,name=parent_id,json=parentId,proto3" json:"parent_id,omitempty"`
	// The volume UUID of the parent volume if this volume pertains to a snapshot.
	// 0 if the volume does not pertain to a snapshot
	ParentUuid string `protobuf:"bytes,12,opt,name=parent_uuid,json=parentUuid,proto3" json:"parent_uuid,omitempty"`
	// The snapshot UUID if this volume is a snapshot. Empty if not
	SnapshotUuid         string   `protobuf:"bytes,13,opt,name=snapshot_uuid,json=snapshotUuid,proto3" json:"snapshot_uuid,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *FsVolume) GetParentId() uint32 {
	if m != nil {
		return m.ParentId
	}
	return 0
...
func (m *FsVolume) GetParentUuid() string {
	if m != nil {
		return m.ParentUuid
	}
	return ""
...
func (m *FsVolume) GetSnapshotUuid() string {
	if m != nil {
...
type FsPresentation struct {
	...
	// The snapshot UUID - or empty if this presentation does not pertain
	// to a snapshot, i.e. it's the parent volume.
	SnapshotUuid string `protobuf:"bytes,9,opt,name=snapshot_uuid,json=snapshotUuid,proto3" json:"snapshot_uuid,omitempty"`
...
func (m *FsPresentation) GetSnapshotUuid() string {
	if m != nil {
		return m.SnapshotUuid
	}
	return ""
...
var fileDescriptor_0a9f8093c6c7067e = []byte{
	...
	,
}
