...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      "\n\014common.proto\022\tcommon.v1\",\n\tRpcResult\022\017"
      "\n\007success\030\001 \001(\010\022\016\n\006reason\030\002 \001(\t\"\233\001\n\017Data"
      "planeCommon\0226\n\006labels\030\001 \003(\0132&.common.v1."
      "DataplaneCommon.LabelsEntry\022\023\n\013descripti"
...
RpcResult::RpcResult()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:common.v1.RpcResult)
}
RpcResult::RpcResult(const RpcResult& from)
  ...
  // @@protoc_insertion_point(copy_constructor:common.v1.RpcResult)
}
...
RpcResult::~RpcResult() {
  // @@protoc_insertion_point(destructor:common.v1.RpcResult)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:common.v1.RpcResult)
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:common.v1.RpcResult)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:common.v1.RpcResult)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:common.v1.RpcResult)
  return false;
#undef DO_
}
...
void RpcResult::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:common.v1.RpcResult)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:common.v1.RpcResult)
}

::google::protobuf::uint8* RpcResult::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  (void)deterministic; // Unused
  // @@protoc_insertion_point(serialize_to_array_start:common.v1.RpcResult)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:common.v1.RpcResult)
  return target;
}

size_t RpcResult::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:common.v1.RpcResult)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:common.v1.RpcResult)
  GOOGLE_DCHECK_NE(&from, this);
  const RpcResult* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const RpcResult>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:common.v1.RpcResult)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:common.v1.RpcResult)
    MergeFrom(*source);
  }
}

void RpcResult::MergeFrom(const RpcResult& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:common.v1.RpcResult)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:common.v1.RpcResult)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:common.v1.RpcResult)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
bool RpcResult::success() const {
  // @@protoc_insertion_point(field_get:common.v1.RpcResult.success)
  return success_;
}
void RpcResult::set_success(bool value) {
  
  success_ = value;
  // @@protoc_insertion_point(field_set:common.v1.RpcResult.success)
}
...
const ::std::string& RpcResult::reason() const {
  // @@protoc_insertion_point(field_get:common.v1.RpcResult.reason)
  return reason_.GetNoArena();
}
void RpcResult::set_reason(const ::std::string& value) {
  
  reason_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:common.v1.RpcResult.reason)
}
#if LANG_CXX11
void RpcResult::set_reason(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:common.v1.RpcResult.reason)
}
#endif
void RpcResult::set_reason(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:common.v1.RpcResult.reason)
}
void RpcResult::set_reason(const char* value, size_t size) {
  
  reason_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:common.v1.RpcResult.reason)
}
::std::string* RpcResult::mutable_reason() {
  
  // @@protoc_insertion_point(field_mutable:common.v1.RpcResult.reason)
  return reason_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
::std::string* RpcResult::release_reason() {
  // @@protoc_insertion_point(field_release:common.v1.RpcResult.reason)
...
void RpcResult::set_allocated_reason(::std::string* reason) {
  ...
  // @@protoc_insertion_point(field_set_allocated:common.v1.RpcResult.reason)
}
...
DataplaneCommon::DataplaneCommon()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:common.v1.DataplaneCommon)
}
DataplaneCommon::DataplaneCommon(const DataplaneCommon& from)
  ...
  // @@protoc_insertion_point(copy_constructor:common.v1.DataplaneCommon)
}
...
DataplaneCommon::~DataplaneCommon() {
  // @@protoc_insertion_point(destructor:common.v1.DataplaneCommon)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:common.v1.DataplaneCommon)
  ::google::protobuf::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:common.v1.DataplaneCommon)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
      ...
      case 1: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "common.v1.DataplaneCommon.LabelsEntry.key"));
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            parser.value().data(), static_cast<int>(parser.value().length()),
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "common.v1.DataplaneCommon.LabelsEntry.value"));
        } else {
          goto handle_unusual;
        }
        break;
      ...
      case 2: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "common.v1.DataplaneCommon.description"));
        } else {
          goto handle_unusual;
        }
        break;
      ...
      case 3: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "common.v1.DataplaneCommon.uuid"));
        } else {
          goto handle_unusual;
        }
        break;
...
success:
  // @@protoc_insertion_point(parse_success:common.v1.DataplaneCommon)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:common.v1.DataplaneCommon)
  return false;
#undef DO_
}
...
void DataplaneCommon::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:common.v1.DataplaneCommon)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:common.v1.DataplaneCommon)
}

::google::protobuf::uint8* DataplaneCommon::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  (void)deterministic; // Unused
  // @@protoc_insertion_point(serialize_to_array_start:common.v1.DataplaneCommon)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:common.v1.DataplaneCommon)
  return target;
}

size_t DataplaneCommon::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:common.v1.DataplaneCommon)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:common.v1.DataplaneCommon)
  GOOGLE_DCHECK_NE(&from, this);
  const DataplaneCommon* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const DataplaneCommon>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:common.v1.DataplaneCommon)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:common.v1.DataplaneCommon)
    MergeFrom(*source);
  }
}

void DataplaneCommon::MergeFrom(const DataplaneCommon& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:common.v1.DataplaneCommon)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:common.v1.DataplaneCommon)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:common.v1.DataplaneCommon)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
DataplaneCommon::labels() const {
  // @@protoc_insertion_point(field_map:common.v1.DataplaneCommon.labels)
  return labels_.GetMap();
}
 ::google::protobuf::Map< ::std::string, ::std::string >*
DataplaneCommon::mutable_labels() {
  // @@protoc_insertion_point(field_mutable_map:common.v1.DataplaneCommon.labels)
...
const ::std::string& DataplaneCommon::description() const {
  // @@protoc_insertion_point(field_get:common.v1.DataplaneCommon.description)
  return description_.GetNoArena();
}
void DataplaneCommon::set_description(const ::std::string& value) {
  
  description_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:common.v1.DataplaneCommon.description)
}
#if LANG_CXX11
void DataplaneCommon::set_description(::std::string&& value) {
  ...
  description_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:common.v1.DataplaneCommon.description)
}
#endif
void DataplaneCommon::set_description(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:common.v1.DataplaneCommon.description)
}
void DataplaneCommon::set_description(const char* value, size_t size) {
  
  description_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:common.v1.DataplaneCommon.description)
}
::std::string* DataplaneCommon::mutable_description() {
  
  // @@protoc_insertion_point(field_mutable:common.v1.DataplaneCommon.description)
  return description_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
::std::string* DataplaneCommon::release_description() {
  // @@protoc_insertion_point(field_release:common.v1.DataplaneCommon.description)
...
void DataplaneCommon::set_allocated_description(::std::string* description) {
  ...
  // @@protoc_insertion_point(field_set_allocated:common.v1.DataplaneCommon.description)
}
...
const ::std::string& DataplaneCommon::uuid() const {
  // @@protoc_insertion_point(field_get:common.v1.DataplaneCommon.uuid)
  return uuid_.GetNoArena();
}
void DataplaneCommon::set_uuid(const ::std::string& value) {
  
  uuid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:common.v1.DataplaneCommon.uuid)
}
#if LANG_CXX11
void DataplaneCommon::set_uuid(::std::string&& value) {
  ...
  uuid_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:common.v1.DataplaneCommon.uuid)
}
#endif
void DataplaneCommon::set_uuid(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:common.v1.DataplaneCommon.uuid)
}
void DataplaneCommon::set_uuid(const char* value, size_t size) {
  
  uuid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:common.v1.DataplaneCommon.uuid)
}
::std::string* DataplaneCommon::mutable_uuid() {
  
  // @@protoc_insertion_point(field_mutable:common.v1.DataplaneCommon.uuid)
  return uuid_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
::std::string* DataplaneCommon::release_uuid() {
  // @@protoc_insertion_point(field_release:common.v1.DataplaneCommon.uuid)
...
void DataplaneCommon::set_allocated_uuid(::std::string* uuid) {
  ...
  // @@protoc_insertion_point(field_set_allocated:common.v1.DataplaneCommon.uuid)
}
