...
class RpcResult : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:common.v1.RpcResult) */ {
 public:
  RpcResult();
  virtual ~RpcResult();
...
class DataplaneCommon : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:common.v1.DataplaneCommon) */ {
 public:
  DataplaneCommon();
