...
var file_supervisor_proto_rawDesc = []byte{
	...
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6f, 0x6e, 0x64, 0x61, 0x74, 0x2f, 0x73,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2f, 0x73, 0x75, 0x70, 0x65, 0x72, 0x76, 0x69, 0x73, 0x6f,
...
var file_supervisor_proto_goTypes = []interface{}{
	...
	nil,                                                 // 54: supervisor.v1.PresentationConfig.LabelsEntry
...
var file_supervisor_proto_depIdxs = []int32{
	...
	62, // 4: supervisor.v1.PresentationConfig.cc:type_name -> common.v1.ConsumerCount
	2,  // 5: supervisor.v1.PresentationConfig.opt_node_config:type_name -> supervisor.v1.NodeConfig
	63, // 6: supervisor.v1.PresentationConfig.opt_volume_crypto:type_name -> common.v1.VolumeCrypto
	54, // 7: supervisor.v1.PresentationConfig.labels:type_name -> supervisor.v1.PresentationConfig.LabelsEntry
	3,  // 8: supervisor.v1.ConfigureDeploymentRequest.config:type_name -> supervisor.v1.DeploymentConfig
	64, // 9: supervisor.v1.ConfigureDeploymentResponse.rpc_result:type_name -> common.v1.RpcResult
	64, // 10: supervisor.v1.DeconfigureDeploymentResponse.rpc_result:type_name -> common.v1.RpcResult
	64, // 11: supervisor.v1.DeleteDeploymentResponse.rpc_result:type_name -> common.v1.RpcResult
	4,  // 12: supervisor.v1.ConfigurePresentationRequest.config:type_name -> supervisor.v1.PresentationConfig
	64, // 13: supervisor.v1.ConfigurePresentationResponse.rpc_result:type_name -> common.v1.RpcResult
	5,  // 14: supervisor.v1.ConfigurePresentationResponse.device_info:type_name -> supervisor.v1.PresentationScsiDevice
	64, // 15: supervisor.v1.DeconfigurePresentationResponse.rpc_result:type_name -> common.v1.RpcResult
	62, // 16: supervisor.v1.SetConsumerCountRequest.cc:type_name -> common.v1.ConsumerCount
	64, // 17: supervisor.v1.SetConsumerCountResponse.rpc_result:type_name -> common.v1.RpcResult
	62, // 18: supervisor.v1.SetConsumerCountResponse.cc:type_name -> common.v1.ConsumerCount
	64, // 19: supervisor.v1.GetConsumerCountResponse.rpc_result:type_name -> common.v1.RpcResult
	62, // 20: supervisor.v1.GetConsumerCountResponse.cc:type_name -> common.v1.ConsumerCount
	57, // 21: supervisor.v1.DumpConfigResponse.deployments:type_name -> supervisor.v1.DumpConfigResponse.DeploymentsEntry
	58, // 22: supervisor.v1.DumpConfigResponse.presentations:type_name -> supervisor.v1.DumpConfigResponse.PresentationsEntry
	59, // 23: supervisor.v1.DumpConfigResponse.connections:type_name -> supervisor.v1.DumpConfigResponse.ConnectionsEntry
	64, // 24: supervisor.v1.CreateSnapshotResponse.rpc_result:type_name -> common.v1.RpcResult
	64, // 25: supervisor.v1.ReapSnapshotResponse.rpc_result:type_name -> common.v1.RpcResult
	22, // 26: supervisor.v1.ListSnapshotsResponse.snapshots:type_name -> supervisor.v1.Snapshot
	31, // 27: supervisor.v1.DeploymentHashListRequest.sync_context:type_name -> supervisor.v1.SyncContext
	32, // 28: supervisor.v1.DeploymentHashListResponse.deployment_hash:type_name -> supervisor.v1.DeploymentHash
	32, // 29: supervisor.v1.DeploymentHashListResponse.hash_list:type_name -> supervisor.v1.DeploymentHash
	1,  // 30: supervisor.v1.Metric.type:type_name -> supervisor.v1.MetricType
	35, // 31: supervisor.v1.VolumeMetrics.metrics:type_name -> supervisor.v1.Metric
	35, // 32: supervisor.v1.NodeMetrics.metrics:type_name -> supervisor.v1.Metric
	60, // 33: supervisor.v1.MetricsResponse.volume_metrics:type_name -> supervisor.v1.MetricsResponse.VolumeMetricsEntry
	38, // 34: supervisor.v1.MetricsResponse.node_metrics:type_name -> supervisor.v1.NodeMetrics
	61, // 35: supervisor.v1.ListConnectionsResponse.connections:type_name -> supervisor.v1.ListConnectionsResponse.ConnectionsEntry
	2,  // 36: supervisor.v1.AddConnectionRequest.config:type_name -> supervisor.v1.NodeConfig
	64, // 37: supervisor.v1.AddConnectionResponse.rpc_result:type_name -> common.v1.RpcResult
	2,  // 38: supervisor.v1.RemoveConnectionRequest.config:type_name -> supervisor.v1.NodeConfig
	64, // 39: supervisor.v1.RemoveConnectionResponse.rpc_result:type_name -> common.v1.RpcResult
	47, // 40: supervisor.v1.SyncRegionsRequest.regions:type_name -> supervisor.v1.SyncRegion
	31, // 41: supervisor.v1.SyncRegionsRequest.sync_context:type_name -> supervisor.v1.SyncContext
	31, // 42: supervisor.v1.SyncRegionRequest.sync_context:type_name -> supervisor.v1.SyncContext
	...
	55, // 47: supervisor.v1.DumpConfigResponse.DeploymentsEntry.value:type_name -> supervisor.v1.DumpConfigResponse.DeploymentConfigBundle
	56, // 48: supervisor.v1.DumpConfigResponse.PresentationsEntry.value:type_name -> supervisor.v1.DumpConfigResponse.PresentationConfigBundle
	41, // 49: supervisor.v1.DumpConfigResponse.ConnectionsEntry.value:type_name -> supervisor.v1.Connection
	37, // 50: supervisor.v1.MetricsResponse.VolumeMetricsEntry.value:type_name -> supervisor.v1.VolumeMetrics
	41, // 51: supervisor.v1.ListConnectionsResponse.ConnectionsEntry.value:type_name -> supervisor.v1.Connection
	...
	40, // 76: supervisor.v1.Supervisor.ListConnections:input_type -> supervisor.v1.ListConnectionsRequest
	43, // 77: supervisor.v1.Supervisor.AddConnection:input_type -> supervisor.v1.AddConnectionRequest
	45, // 78: supervisor.v1.Supervisor.RemoveConnection:input_type -> supervisor.v1.RemoveConnectionRequest
	48, // 79: supervisor.v1.Supervisor.SyncRegions:input_type -> supervisor.v1.SyncRegionsRequest
	33, // 80: supervisor.v1.Supervisor.DeploymentHashList:input_type -> supervisor.v1.DeploymentHashListRequest
	36, // 81: supervisor.v1.Supervisor.Metrics:input_type -> supervisor.v1.MetricsRequest
	...
	28, // 89: supervisor.v1.Supervisor.ReapSnapshot:output_type -> supervisor.v1.ReapSnapshotResponse
	30, // 90: supervisor.v1.Supervisor.ListSnapshots:output_type -> supervisor.v1.ListSnapshotsResponse
	19, // 91: supervisor.v1.Supervisor.SetConsumerCount:output_type -> supervisor.v1.SetConsumerCountResponse
	21, // 92: supervisor.v1.Supervisor.GetConsumerCount:output_type -> supervisor.v1.GetConsumerCountResponse
	24, // 93: supervisor.v1.Supervisor.DumpConfig:output_type -> supervisor.v1.DumpConfigResponse
	71, // 94: supervisor.v1.Supervisor.ConfigGetBool:output_type -> common.v1.ConfigGetBoolReply
	72, // 95: supervisor.v1.Supervisor.ConfigUpdateBool:output_type -> common.v1.ConfigUpdateReply
	73, // 96: supervisor.v1.Supervisor.ConfigListBool:output_type -> common.v1.ConfigBoolList
	74, // 97: supervisor.v1.Supervisor.ConfigGetString:output_type -> common.v1.ConfigGetStringReply
	72, // 98: supervisor.v1.Supervisor.ConfigUpdateString:output_type -> common.v1.ConfigUpdateReply
	75, // 99: supervisor.v1.Supervisor.ConfigListString:output_type -> common.v1.ConfigStringList
	76, // 100: supervisor.v1.Supervisor.ConfigGetUint32:output_type -> common.v1.ConfigGetUint32Reply
	72, // 101: supervisor.v1.Supervisor.ConfigUpdateUint32:output_type -> common.v1.ConfigUpdateReply
	77, // 102: supervisor.v1.Supervisor.ConfigListUint32:output_type -> common.v1.ConfigUint32List
	78, // 103: supervisor.v1.Supervisor.ConfigGetUint64:output_type -> common.v1.ConfigGetUint64Reply
	72, // 104: supervisor.v1.Supervisor.ConfigUpdateUint64:output_type -> common.v1.ConfigUpdateReply
	79, // 105: supervisor.v1.Supervisor.ConfigListUint64:output_type -> common.v1.ConfigUint64List
	42, // 106: supervisor.v1.Supervisor.ListConnections:output_type -> supervisor.v1.ListConnectionsResponse
	44, // 107: supervisor.v1.Supervisor.AddConnection:output_type -> supervisor.v1.AddConnectionResponse
	46, // 108: supervisor.v1.Supervisor.RemoveConnection:output_type -> supervisor.v1.RemoveConnectionResponse
	49, // 109: supervisor.v1.Supervisor.SyncRegions:output_type -> supervisor.v1.SyncRegionsResponse
	34, // 110: supervisor.v1.Supervisor.DeploymentHashList:output_type -> supervisor.v1.DeploymentHashListResponse
	39, // 111: supervisor.v1.Supervisor.Metrics:output_type -> supervisor.v1.MetricsResponse
