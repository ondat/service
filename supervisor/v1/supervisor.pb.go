...
const (
	VolumeHashListRpcVersion_V1 VolumeHashListRpcVersion = 0 // < Storageos v2.4.0
	VolumeHashListRpcVersion_V2 VolumeHashListRpcVersion = 1 // >= Storageos v2.4.0: in this verison we make the change outlined
)

// Enum value maps for VolumeHashListRpcVersion.
var (
	VolumeHashListRpcVersion_name = map[int32]string{
		0: "V1",
		1: "V2",
	}
	VolumeHashListRpcVersion_value = map[string]int32{
		"V1": 0,
		"V2": 1,
	}
)

func (x VolumeHashListRpcVersion) Enum() *VolumeHashListRpcVersion {
	p := new(VolumeHashListRpcVersion)
	*p = x
	return p
}
...
func (VolumeHashListRpcVersion) Descriptor() protoreflect.EnumDescriptor {
	return file_supervisor_proto_enumTypes[0].Descriptor()
}

func (VolumeHashListRpcVersion) Type() protoreflect.EnumType {
	return &file_supervisor_proto_enumTypes[0]
}

func (x VolumeHashListRpcVersion) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use VolumeHashListRpcVersion.Descriptor instead.
...
const (
	...
	IdMapperStatus_GSI    IdMapperStatus_MapMode = 1 // Global-scope inodes (v1).
	IdMapperStatus_NLI    IdMapperStatus_MapMode = 2 // Node-local inodes (v2).
)
...
func (IdMapperStatus_MapMode) EnumDescriptor() ([]byte, []int) {
	return file_supervisor_proto_rawDescGZIP(), []int{28, 0}
}
...
type ReplicaDeploymentConfig struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ReplicaDeploymentConfig) Reset() {
	*x = ReplicaDeploymentConfig{}
	if protoimpl.UnsafeEnabled {
...
func (x *ReplicaDeploymentConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReplicaDeploymentConfig) ProtoMessage() {}

func (x *ReplicaDeploymentConfig) ProtoReflect() protoreflect.Message {
	mi := &file_supervisor_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReplicaDeploymentConfig.ProtoReflect.Descriptor instead.
func (*ReplicaDeploymentConfig) Descriptor() ([]byte, []int) {
	return file_supervisor_proto_rawDescGZIP(), []int{1}
}

func (x *ReplicaDeploymentConfig) GetUuid() string {
	if x != nil {
		return x.Uuid
	}
	return ""
...
func (x *ReplicaDeploymentConfig) GetId() uint32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *ReplicaDeploymentConfig) GetUsesCompression() bool {
	if x != nil {
...
type PrimaryDeploymentConfig struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The primary deployment's UUID
	PrimaryUuid string `protobuf:"bytes,1,opt,name=primary_uuid,json=primaryUuid,proto3" json:"primary_uuid,omitempty"`
	// Not for CP use. The internal primary deployment ID used by the dataplane
	// Useful for dataplane testing and not much else
	PrimaryId uint32 `protobuf:"varint,2,opt,name=primary_id,json=primaryId,proto3" json:"primary_id,omitempty"`
	// Whether the deployment uses compression. In reality this is a per volume
	// option. All deployments should use compression if the volume uses
	// compression. This field is also sticky, you can't choose to undo at a
	// later date. Compression is applied to the underlying block data which
	// is stored in the blob files. Normally we recommend disabling compression.
	UsesCompression bool `protobuf:"varint,3,opt,name=uses_compression,json=usesCompression,proto3" json:"uses_compression,omitempty"`
	// The consumer count for the volume and thus the primary.
	Cc *v1.ConsumerCount `protobuf:"bytes,4,opt,name=cc,proto3" json:"cc,omitempty"`
	// The replicas associated with this primary. May be empty.
	Replicas []*PrimaryDeploymentConfig_ReplicaAndLocation `protobuf:"bytes,5,rep,name=replicas,proto3" json:"replicas,omitempty"`
}

func (x *PrimaryDeploymentConfig) Reset() {
	*x = PrimaryDeploymentConfig{}
	if protoimpl.UnsafeEnabled {
...
func (x *PrimaryDeploymentConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PrimaryDeploymentConfig) ProtoMessage() {}

func (x *PrimaryDeploymentConfig) ProtoReflect() protoreflect.Message {
	mi := &file_supervisor_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PrimaryDeploymentConfig.ProtoReflect.Descriptor instead.
func (*PrimaryDeploymentConfig) Descriptor() ([]byte, []int) {
	return file_supervisor_proto_rawDescGZIP(), []int{2}
}

func (x *PrimaryDeploymentConfig) GetPrimaryUuid() string {
	if x != nil {
...
func (x *PrimaryDeploymentConfig) GetPrimaryId() uint32 {
	if x != nil {
		return x.PrimaryId
	}
	return 0
...
func (x *PrimaryDeploymentConfig) GetUsesCompression() bool {
	if x != nil {
		return x.UsesCompression
	}
	return false
...
func (x *PrimaryDeploymentConfig) GetCc() *v1.ConsumerCount {
	if x != nil {
		return x.Cc
	}
	return nil
...
func (x *PrimaryDeploymentConfig) GetReplicas() []*PrimaryDeploymentConfig_ReplicaAndLocation {
	if x != nil {
		return x.Replicas
	}
	return nil
...
type PresentationConfig struct {
	...
	// We need to know the UUID of the primary deployment as this is where
	// all IO is directed.
	PrimaryUuid string `protobuf:"bytes,4,opt,name=primary_uuid,json=primaryUuid,proto3" json:"primary_uuid,omitempty"`
	// Not for CP use. The internal primary deployment ID used by the dataplane
	// Useful for dataplane testing and not much else
	PrimaryId uint32 `protobuf:"varint,5,opt,name=primary_id,json=primaryId,proto3" json:"primary_id,omitempty"`
	...
	// Only present if the volume's primary is on a remote node
...
func (x *PresentationConfig) GetPrimaryUuid() string {
	if x != nil {
		return x.PrimaryUuid
	}
	return ""
...
func (x *PresentationConfig) GetPrimaryId() uint32 {
	if x != nil {
		return x.PrimaryId
	}
	return 0
...
type ConfigurePrimaryRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Config *PrimaryDeploymentConfig `protobuf:"bytes,1,opt,name=config,proto3" json:"config,omitempty"`
}

func (x *ConfigurePrimaryRequest) Reset() {
	*x = ConfigurePrimaryRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ConfigurePrimaryRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ConfigurePrimaryRequest) ProtoMessage() {}

func (x *ConfigurePrimaryRequest) ProtoReflect() protoreflect.Message {
	mi := &file_supervisor_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ConfigurePrimaryRequest.ProtoReflect.Descriptor instead.
func (*ConfigurePrimaryRequest) Descriptor() ([]byte, []int) {
	return file_supervisor_proto_rawDescGZIP(), []int{7}
}

func (x *ConfigurePrimaryRequest) GetConfig() *PrimaryDeploymentConfig {
	if x != nil {
		return x.Config
	}
	return nil
...
type ConfigurePrimaryResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ConfigurePrimaryResponse) Reset() {
	*x = ConfigurePrimaryResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ConfigurePrimaryResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ConfigurePrimaryResponse) ProtoMessage() {}

func (x *ConfigurePrimaryResponse) ProtoReflect() protoreflect.Message {
	mi := &file_supervisor_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ConfigurePrimaryResponse.ProtoReflect.Descriptor instead.
func (*ConfigurePrimaryResponse) Descriptor() ([]byte, []int) {
	return file_supervisor_proto_rawDescGZIP(), []int{8}
}

func (x *ConfigurePrimaryResponse) GetRpcResult() *v1.RpcResult {
	if x != nil {
		return x.RpcResult
	}
	return nil
...
type DeconfigurePrimaryRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *DeconfigurePrimaryRequest) Reset() {
	*x = DeconfigurePrimaryRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *DeconfigurePrimaryRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeconfigurePrimaryRequest) ProtoMessage() {}

func (x *DeconfigurePrimaryRequest) ProtoReflect() protoreflect.Message {
	mi := &file_supervisor_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeconfigurePrimaryRequest.ProtoReflect.Descriptor instead.
func (*DeconfigurePrimaryRequest) Descriptor() ([]byte, []int) {
	return file_supervisor_proto_rawDescGZIP(), []int{9}
}

func (x *DeconfigurePrimaryRequest) GetUuid() string {
	if x != nil {
		return x.Uuid
	}
	return ""
...
func (x *DeconfigurePrimaryRequest) GetId() uint32 {
	if x != nil {
		return x.Id
	}
	return 0
...
type DeconfigurePrimaryResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *DeconfigurePrimaryResponse) Reset() {
	*x = DeconfigurePrimaryResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *DeconfigurePrimaryResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeconfigurePrimaryResponse) ProtoMessage() {}

func (x *DeconfigurePrimaryResponse) ProtoReflect() protoreflect.Message {
	mi := &file_supervisor_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeconfigurePrimaryResponse.ProtoReflect.Descriptor instead.
func (*DeconfigurePrimaryResponse) Descriptor() ([]byte, []int) {
	return file_supervisor_proto_rawDescGZIP(), []int{10}
}

func (x *DeconfigurePrimaryResponse) GetRpcResult() *v1.RpcResult {
	if x != nil {
		return x.RpcResult
	}
	return nil
...
type ConfigureReplicaRequest struct {
	...
	Config *ReplicaDeploymentConfig `protobuf:"bytes,1,opt,name=config,proto3" json:"config,omitempty"`
}

func (x *ConfigureReplicaRequest) Reset() {
	*x = ConfigureReplicaRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ConfigureReplicaRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ConfigureReplicaRequest) ProtoMessage() {}

func (x *ConfigureReplicaRequest) ProtoReflect() protoreflect.Message {
	mi := &file_supervisor_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ConfigureReplicaRequest.ProtoReflect.Descriptor instead.
func (*ConfigureReplicaRequest) Descriptor() ([]byte, []int) {
	return file_supervisor_proto_rawDescGZIP(), []int{11}
}

func (x *ConfigureReplicaRequest) GetConfig() *ReplicaDeploymentConfig {
	if x != nil {
		return x.Config
	}
	return nil
...
type ConfigureReplicaResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ConfigureReplicaResponse) Reset() {
	*x = ConfigureReplicaResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ConfigureReplicaResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ConfigureReplicaResponse) ProtoMessage() {}

func (x *ConfigureReplicaResponse) ProtoReflect() protoreflect.Message {
	mi := &file_supervisor_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ConfigureReplicaResponse.ProtoReflect.Descriptor instead.
func (*ConfigureReplicaResponse) Descriptor() ([]byte, []int) {
	return file_supervisor_proto_rawDescGZIP(), []int{12}
}

func (x *ConfigureReplicaResponse) GetRpcResult() *v1.RpcResult {
	if x != nil {
		return x.RpcResult
	}
	return nil
...
type DeconfigureReplicaRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *DeconfigureReplicaRequest) Reset() {
	*x = DeconfigureReplicaRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *DeconfigureReplicaRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeconfigureReplicaRequest) ProtoMessage() {}

func (x *DeconfigureReplicaRequest) ProtoReflect() protoreflect.Message {
	mi := &file_supervisor_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeconfigureReplicaRequest.ProtoReflect.Descriptor instead.
func (*DeconfigureReplicaRequest) Descriptor() ([]byte, []int) {
	return file_supervisor_proto_rawDescGZIP(), []int{13}
}

func (x *DeconfigureReplicaRequest) GetUuid() string {
	if x != nil {
		return x.Uuid
	}
	return ""
...
func (x *DeconfigureReplicaRequest) GetId() uint32 {
	if x != nil {
		return x.Id
	}
	return 0
...
type DeconfigureReplicaResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *DeconfigureReplicaResponse) Reset() {
	*x = DeconfigureReplicaResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *DeconfigureReplicaResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeconfigureReplicaResponse) ProtoMessage() {}

func (x *DeconfigureReplicaResponse) ProtoReflect() protoreflect.Message {
	mi := &file_supervisor_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeconfigureReplicaResponse.ProtoReflect.Descriptor instead.
func (*DeconfigureReplicaResponse) Descriptor() ([]byte, []int) {
	return file_supervisor_proto_rawDescGZIP(), []int{14}
}

func (x *DeconfigureReplicaResponse) GetRpcResult() *v1.RpcResult {
	if x != nil {
		return x.RpcResult
	}
	return nil
...
type DumpConfigResponse struct {
	...
	Primaries     []*PrimaryDeploymentConfig `protobuf:"bytes,1,rep,name=primaries,proto3" json:"primaries,omitempty"`
	Replicas      []*ReplicaDeploymentConfig `protobuf:"bytes,2,rep,name=replicas,proto3" json:"replicas,omitempty"`
	Presentations []*PresentationConfig      `protobuf:"bytes,3,rep,name=presentations,proto3" json:"presentations,omitempty"`
}
...
func (x *DumpConfigResponse) GetPrimaries() []*PrimaryDeploymentConfig {
	if x != nil {
		return x.Primaries
	}
	return nil
...
func (x *DumpConfigResponse) GetReplicas() []*ReplicaDeploymentConfig {
	if x != nil {
		return x.Replicas
	}
	return nil
...
func (x *DumpConfigResponse) GetPresentations() []*PresentationConfig {
	if x != nil {
...
// * symmetra then calls the Sync() RPC multiple times on the master to copy the
// data
//
...
// subsequent VolumeHashListRequests and SyncRegionRequests. Any code taking
...
func (x *VolumeHash) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VolumeHash) ProtoMessage() {}

func (x *VolumeHash) ProtoReflect() protoreflect.Message {
	mi := &file_supervisor_proto_msgTypes[32]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VolumeHash.ProtoReflect.Descriptor instead.
func (*VolumeHash) Descriptor() ([]byte, []int) {
	return file_supervisor_proto_rawDescGZIP(), []int{32}
}

func (x *VolumeHash) GetBytes() []byte {
	if x != nil {
		return x.Bytes
	}
	return nil
...
type VolumeHashListRequest struct {
	...
	// for clients to specify this size they can optimise based on volume size
...
func (x *VolumeHashListRequest) Reset() {
	*x = VolumeHashListRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *VolumeHashListRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VolumeHashListRequest) ProtoMessage() {}

func (x *VolumeHashListRequest) ProtoReflect() protoreflect.Message {
	mi := &file_supervisor_proto_msgTypes[33]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VolumeHashListRequest.ProtoReflect.Descriptor instead.
func (*VolumeHashListRequest) Descriptor() ([]byte, []int) {
	return file_supervisor_proto_rawDescGZIP(), []int{33}
}

func (x *VolumeHashListRequest) GetVersion() VolumeHashListRpcVersion {
	if x != nil {
		return x.Version
	}
...
func (x *VolumeHashListRequest) GetVolumeId() uint32 {
	if x != nil {
		return x.VolumeId
	}
	return 0
...
func (x *VolumeHashListRequest) GetVolumeUuid() string {
	if x != nil {
		return x.VolumeUuid
	}
	return ""
...
func (x *VolumeHashListRequest) GetStartOffset() uint64 {
	if x != nil {
...
func (x *VolumeHashListRequest) GetEndOffset() uint64 {
	if x != nil {
		return x.EndOffset
	}
	return 0
...
func (x *VolumeHashListRequest) GetRegionSize() uint64 {
	if x != nil {
		return x.RegionSize
	}
	return 0
...
func (x *VolumeHashListRequest) GetIsCompressed() bool {
	if x != nil {
...
func (x *VolumeHashListRequest) GetSyncContext() *SyncContext {
	if x != nil {
...
func (x *VolumeHashListResponse) Reset() {
	*x = VolumeHashListResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *VolumeHashListResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VolumeHashListResponse) ProtoMessage() {}

func (x *VolumeHashListResponse) ProtoReflect() protoreflect.Message {
	mi := &file_supervisor_proto_msgTypes[34]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VolumeHashListResponse.ProtoReflect.Descriptor instead.
func (*VolumeHashListResponse) Descriptor() ([]byte, []int) {
	return file_supervisor_proto_rawDescGZIP(), []int{34}
}

func (x *VolumeHashListResponse) GetVersion() VolumeHashListRpcVersion {
	if x != nil {
		return x.Version
	}
	return VolumeHashListRpcVersion_V1
...
func (x *VolumeHashListResponse) GetVolumeHash() *VolumeHash {
	if x != nil {
		return x.VolumeHash
	}
	return nil
...
func (x *VolumeHashListResponse) GetStartOffset() uint64 {
	if x != nil {
		return x.StartOffset
	}
	return 0
...
func (x *VolumeHashListResponse) GetEndOffset() uint64 {
	if x != nil {
		return x.EndOffset
	}
	return 0
...
func (x *VolumeHashListResponse) GetHashList() []*VolumeHash {
	if x != nil {
		return x.HashList
	}
	return nil
...
type MetricsRequest struct {
	...
	// A list of volumes to query (by inode). If this and uuids is left empty
...
func (x *MetricsRequest) GetInodes() []uint32 {
	if x != nil {
		return x.Inodes
	}
	return nil
...
func (x *VolumeMetrics) GetInode() uint32 {
	if x != nil {
		return x.Inode
	}
	return 0
...
type SyncRegionsRequest struct {
	...
	SourceVolume uint32 `protobuf:"varint,1,opt,name=source_volume,json=sourceVolume,proto3" json:"source_volume,omitempty"`
	// The source UUID.
	...
	DestinationVolume uint32 `protobuf:"varint,3,opt,name=destination_volume,json=destinationVolume,proto3" json:"destination_volume,omitempty"`
	...
	// primary) and the sync target (the replica) to establish before trying to
...
func (x *SyncRegionsRequest) GetSourceVolume() uint32 {
	if x != nil {
...
func (x *SyncRegionsRequest) GetDestinationVolume() uint32 {
	if x != nil {
...
type PrimaryDeploymentConfig_ReplicaAndLocation struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// which signifies the replica is local to the primary
...
func (x *PrimaryDeploymentConfig_ReplicaAndLocation) Reset() {
	*x = PrimaryDeploymentConfig_ReplicaAndLocation{}
	if protoimpl.UnsafeEnabled {
...
func (x *PrimaryDeploymentConfig_ReplicaAndLocation) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PrimaryDeploymentConfig_ReplicaAndLocation) ProtoMessage() {}

func (x *PrimaryDeploymentConfig_ReplicaAndLocation) ProtoReflect() protoreflect.Message {
	mi := &file_supervisor_proto_msgTypes[45]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PrimaryDeploymentConfig_ReplicaAndLocation.ProtoReflect.Descriptor instead.
func (*PrimaryDeploymentConfig_ReplicaAndLocation) Descriptor() ([]byte, []int) {
	return file_supervisor_proto_rawDescGZIP(), []int{2, 0}
}

func (x *PrimaryDeploymentConfig_ReplicaAndLocation) GetUuid() string {
	if x != nil {
		return x.Uuid
	}
	return ""
...
func (x *PrimaryDeploymentConfig_ReplicaAndLocation) GetId() uint32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *PrimaryDeploymentConfig_ReplicaAndLocation) GetOptNodeConfig() *NodeConfig {
	if x != nil {
		return x.OptNodeConfig
	}
	return nil
...
var file_supervisor_proto_rawDesc = []byte{
	...
	0x22, 0x68, 0x0a, 0x17, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x44, 0x65, 0x70, 0x6c, 0x6f,
	0x79, 0x6d, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x12, 0x0a, 0x04, 0x75,
	...
	,
	...
	,
	...
	,
	...
	0x72, 0x22, 0x19, 0x0a, 0x17, 0x53, 0x75, 0x70, 0x65, 0x72, 0x76, 0x69, 0x73, 0x6f, 0x72, 0x53,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x83, 0x02, 0x0a,
	0x18, 0x53, 0x75, 0x70, 0x65, 0x72, 0x76, 0x69, 0x73, 0x6f, 0x72, 0x53, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x33, 0x0a, 0x0a, 0x72, 0x70, 0x63,
	...
	,
	...
	,
	...
	,
	...
	0x74, 0x52, 0x09, 0x72, 0x70, 0x63, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x67, 0x0a, 0x17,
	0x53, 0x65, 0x74, 0x43, 0x6f, 0x6e, 0x73, 0x75, 0x6d, 0x65, 0x72, 0x43, 0x6f, 0x75, 0x6e, 0x74,
	...
	0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x02, 0x69, 0x64, 0x12, 0x28, 0x0a, 0x02, 0x63,
	0x63, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e,
	0x2e, 0x76, 0x31, 0x2e, 0x43, 0x6f, 0x6e, 0x73, 0x75, 0x6d, 0x65, 0x72, 0x43, 0x6f, 0x75, 0x6e,
	0x74, 0x52, 0x02, 0x63, 0x63, 0x22, 0x79, 0x0a, 0x18, 0x53, 0x65, 0x74, 0x43, 0x6f, 0x6e, 0x73,
	...
	,
	...
	0x12, 0x28, 0x0a, 0x02, 0x63, 0x63, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x63,
	...
	,
	...
	,
	...
	0x65, 0x74, 0x12, 0x36, 0x0a, 0x09, 0x68, 0x61, 0x73, 0x68, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18,
	0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x73, 0x75, 0x70, 0x65, 0x72, 0x76, 0x69, 0x73,
	0x6f, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x56, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x48, 0x61, 0x73, 0x68,
	0x52, 0x08, 0x68, 0x61, 0x73, 0x68, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x61, 0x0a, 0x06, 0x4d, 0x65,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x00, 0x12, 0x74, 0x0a, 0x15, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72, 0x65, 0x50, 0x72,
	0x65, 0x73, 0x65, 0x6e, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x2b, 0x2e, 0x73, 0x75, 0x70,
	0x65, 0x72, 0x76, 0x69, 0x73, 0x6f, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x6f, 0x6e, 0x66, 0x69,
	0x67, 0x75, 0x72, 0x65, 0x50, 0x72, 0x65, 0x73, 0x65, 0x6e, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	,
	...
	,
	...
	,
	...
	0x2f, 0x73, 0x75, 0x70, 0x65, 0x72, 0x76, 0x69, 0x73, 0x6f, 0x72, 0x2f, 0x76, 0x31, 0x62, 0x06,
...
var file_supervisor_proto_msgTypes = make([]protoimpl.MessageInfo, 46)
var file_supervisor_proto_goTypes = []interface{}{
	(VolumeHashListRpcVersion)(0),                      // 0: supervisor.v1.VolumeHashListRpcVersion
	...
	(*ReplicaDeploymentConfig)(nil),                    // 4: supervisor.v1.ReplicaDeploymentConfig
	(*PrimaryDeploymentConfig)(nil),                    // 5: supervisor.v1.PrimaryDeploymentConfig
	(*PresentationConfig)(nil),                         // 6: supervisor.v1.PresentationConfig
	(*PresentationScsiDevice)(nil),                     // 7: supervisor.v1.PresentationScsiDevice
	(*SupervisorStatusRequest)(nil),                    // 8: supervisor.v1.SupervisorStatusRequest
	(*SupervisorStatusResponse)(nil),                   // 9: supervisor.v1.SupervisorStatusResponse
	(*ConfigurePrimaryRequest)(nil),                    // 10: supervisor.v1.ConfigurePrimaryRequest
	(*ConfigurePrimaryResponse)(nil),                   // 11: supervisor.v1.ConfigurePrimaryResponse
	(*DeconfigurePrimaryRequest)(nil),                  // 12: supervisor.v1.DeconfigurePrimaryRequest
	(*DeconfigurePrimaryResponse)(nil),                 // 13: supervisor.v1.DeconfigurePrimaryResponse
	(*ConfigureReplicaRequest)(nil),                    // 14: supervisor.v1.ConfigureReplicaRequest
	(*ConfigureReplicaResponse)(nil),                   // 15: supervisor.v1.ConfigureReplicaResponse
	(*DeconfigureReplicaRequest)(nil),                  // 16: supervisor.v1.DeconfigureReplicaRequest
	(*DeconfigureReplicaResponse)(nil),                 // 17: supervisor.v1.DeconfigureReplicaResponse
	(*DeleteDeploymentRequest)(nil),                    // 18: supervisor.v1.DeleteDeploymentRequest
	(*DeleteDeploymentResponse)(nil),                   // 19: supervisor.v1.DeleteDeploymentResponse
	(*ConfigurePresentationRequest)(nil),               // 20: supervisor.v1.ConfigurePresentationRequest
	(*ConfigurePresentationResponse)(nil),              // 21: supervisor.v1.ConfigurePresentationResponse
	(*DeconfigurePresentationRequest)(nil),             // 22: supervisor.v1.DeconfigurePresentationRequest
	(*DeconfigurePresentationResponse)(nil),            // 23: supervisor.v1.DeconfigurePresentationResponse
	(*SetConsumerCountRequest)(nil),                    // 24: supervisor.v1.SetConsumerCountRequest
	(*SetConsumerCountResponse)(nil),                   // 25: supervisor.v1.SetConsumerCountResponse
	(*GetConsumerCountRequest)(nil),                    // 26: supervisor.v1.GetConsumerCountRequest
	(*GetConsumerCountResponse)(nil),                   // 27: supervisor.v1.GetConsumerCountResponse
	(*DumpConfigRequest)(nil),                          // 28: supervisor.v1.DumpConfigRequest
	(*DumpConfigResponse)(nil),                         // 29: supervisor.v1.DumpConfigResponse
	(*IdMapping)(nil),                                  // 30: supervisor.v1.IdMapping
	(*IdMapperStatus)(nil),                             // 31: supervisor.v1.IdMapperStatus
	(*ConsumerCountStatus)(nil),                        // 32: supervisor.v1.ConsumerCountStatus
	(*ConsumerCountEntry)(nil),                         // 33: supervisor.v1.ConsumerCountEntry
	(*SyncContext)(nil),                                // 34: supervisor.v1.SyncContext
	(*VolumeHash)(nil),                                 // 35: supervisor.v1.VolumeHash
	(*VolumeHashListRequest)(nil),                      // 36: supervisor.v1.VolumeHashListRequest
	(*VolumeHashListResponse)(nil),                     // 37: supervisor.v1.VolumeHashListResponse
	(*Metric)(nil),                                     // 38: supervisor.v1.Metric
	(*MetricsRequest)(nil),                             // 39: supervisor.v1.MetricsRequest
	(*VolumeMetrics)(nil),                              // 40: supervisor.v1.VolumeMetrics
	(*NodeMetrics)(nil),                                // 41: supervisor.v1.NodeMetrics
	(*MetricsResponse)(nil),                            // 42: supervisor.v1.MetricsResponse
	(*SyncRegion)(nil),                                 // 43: supervisor.v1.SyncRegion
	(*SyncRegionsRequest)(nil),                         // 44: supervisor.v1.SyncRegionsRequest
	(*SyncRegionsResponse)(nil),                        // 45: supervisor.v1.SyncRegionsResponse
	(*SyncRegionRequest)(nil),                          // 46: supervisor.v1.SyncRegionRequest
	(*SyncRegionResponse)(nil),                         // 47: supervisor.v1.SyncRegionResponse
	(*PrimaryDeploymentConfig_ReplicaAndLocation)(nil), // 48: supervisor.v1.PrimaryDeploymentConfig.ReplicaAndLocation
	(*v1.ConsumerCount)(nil),                           // 49: common.v1.ConsumerCount
	(*v1.VolumeCrypto)(nil),                            // 50: common.v1.VolumeCrypto
	(*v1.RpcResult)(nil),                               // 51: common.v1.RpcResult
	(*v1.DaemonStatus)(nil),                            // 52: common.v1.DaemonStatus
	(*v1.ConfigKey)(nil),                               // 53: common.v1.ConfigKey
	(*v1.ConfigBool)(nil),                              // 54: common.v1.ConfigBool
	(*v1.ConfigListQuery)(nil),                         // 55: common.v1.ConfigListQuery
	(*v1.ConfigString)(nil),                            // 56: common.v1.ConfigString
	(*v1.ConfigUint32)(nil),                            // 57: common.v1.ConfigUint32
	(*v1.ConfigUint64)(nil),                            // 58: common.v1.ConfigUint64
	(*v1.ConfigGetBoolReply)(nil),                      // 59: common.v1.ConfigGetBoolReply
	(*v1.ConfigUpdateReply)(nil),                       // 60: common.v1.ConfigUpdateReply
	(*v1.ConfigBoolList)(nil),                          // 61: common.v1.ConfigBoolList
	(*v1.ConfigGetStringReply)(nil),                    // 62: common.v1.ConfigGetStringReply
	(*v1.ConfigStringList)(nil),                        // 63: common.v1.ConfigStringList
	(*v1.ConfigGetUint32Reply)(nil),                    // 64: common.v1.ConfigGetUint32Reply
	(*v1.ConfigUint32List)(nil),                        // 65: common.v1.ConfigUint32List
	(*v1.ConfigGetUint64Reply)(nil),                    // 66: common.v1.ConfigGetUint64Reply
	(*v1.ConfigUint64List)(nil),                        // 67: common.v1.ConfigUint64List
}
var file_supervisor_proto_depIdxs = []int32{
	49, // 0: supervisor.v1.PrimaryDeploymentConfig.cc:type_name -> common.v1.ConsumerCount
	48, // 1: supervisor.v1.PrimaryDeploymentConfig.replicas:type_name -> supervisor.v1.PrimaryDeploymentConfig.ReplicaAndLocation
	49, // 2: supervisor.v1.PresentationConfig.cc:type_name -> common.v1.ConsumerCount
	3,  // 3: supervisor.v1.PresentationConfig.opt_node_config:type_name -> supervisor.v1.NodeConfig
	50, // 4: supervisor.v1.PresentationConfig.opt_volume_crypto:type_name -> common.v1.VolumeCrypto
	51, // 5: supervisor.v1.SupervisorStatusResponse.rpc_result:type_name -> common.v1.RpcResult
	52, // 6: supervisor.v1.SupervisorStatusResponse.status:type_name -> common.v1.DaemonStatus
	31, // 7: supervisor.v1.SupervisorStatusResponse.idmap_status:type_name -> supervisor.v1.IdMapperStatus
	32, // 8: supervisor.v1.SupervisorStatusResponse.cc_status:type_name -> supervisor.v1.ConsumerCountStatus
	5,  // 9: supervisor.v1.ConfigurePrimaryRequest.config:type_name -> supervisor.v1.PrimaryDeploymentConfig
	51, // 10: supervisor.v1.ConfigurePrimaryResponse.rpc_result:type_name -> common.v1.RpcResult
	51, // 11: supervisor.v1.DeconfigurePrimaryResponse.rpc_result:type_name -> common.v1.RpcResult
	4,  // 12: supervisor.v1.ConfigureReplicaRequest.config:type_name -> supervisor.v1.ReplicaDeploymentConfig
	51, // 13: supervisor.v1.ConfigureReplicaResponse.rpc_result:type_name -> common.v1.RpcResult
	51, // 14: supervisor.v1.DeconfigureReplicaResponse.rpc_result:type_name -> common.v1.RpcResult
	51, // 15: supervisor.v1.DeleteDeploymentResponse.rpc_result:type_name -> common.v1.RpcResult
	6,  // 16: supervisor.v1.ConfigurePresentationRequest.config:type_name -> supervisor.v1.PresentationConfig
	51, // 17: supervisor.v1.ConfigurePresentationResponse.rpc_result:type_name -> common.v1.RpcResult
	7,  // 18: supervisor.v1.ConfigurePresentationResponse.device_info:type_name -> supervisor.v1.PresentationScsiDevice
	51, // 19: supervisor.v1.DeconfigurePresentationResponse.rpc_result:type_name -> common.v1.RpcResult
	49, // 20: supervisor.v1.SetConsumerCountRequest.cc:type_name -> common.v1.ConsumerCount
	51, // 21: supervisor.v1.SetConsumerCountResponse.rpc_result:type_name -> common.v1.RpcResult
	49, // 22: supervisor.v1.SetConsumerCountResponse.cc:type_name -> common.v1.ConsumerCount
	51, // 23: supervisor.v1.GetConsumerCountResponse.rpc_result:type_name -> common.v1.RpcResult
	49, // 24: supervisor.v1.GetConsumerCountResponse.cc:type_name -> common.v1.ConsumerCount
	5,  // 25: supervisor.v1.DumpConfigResponse.primaries:type_name -> supervisor.v1.PrimaryDeploymentConfig
	4,  // 26: supervisor.v1.DumpConfigResponse.replicas:type_name -> supervisor.v1.ReplicaDeploymentConfig
	6,  // 27: supervisor.v1.DumpConfigResponse.presentations:type_name -> supervisor.v1.PresentationConfig
	2,  // 28: supervisor.v1.IdMapperStatus.mode:type_name -> supervisor.v1.IdMapperStatus.MapMode
	30, // 29: supervisor.v1.IdMapperStatus.mappings:type_name -> supervisor.v1.IdMapping
	33, // 30: supervisor.v1.ConsumerCountStatus.ccs:type_name -> supervisor.v1.ConsumerCountEntry
	30, // 31: supervisor.v1.ConsumerCountEntry.mapping:type_name -> supervisor.v1.IdMapping
	49, // 32: supervisor.v1.ConsumerCountEntry.cc:type_name -> common.v1.ConsumerCount
	0,  // 33: supervisor.v1.VolumeHashListRequest.version:type_name -> supervisor.v1.VolumeHashListRpcVersion
	34, // 34: supervisor.v1.VolumeHashListRequest.sync_context:type_name -> supervisor.v1.SyncContext
	0,  // 35: supervisor.v1.VolumeHashListResponse.version:type_name -> supervisor.v1.VolumeHashListRpcVersion
	35, // 36: supervisor.v1.VolumeHashListResponse.volume_hash:type_name -> supervisor.v1.VolumeHash
	35, // 37: supervisor.v1.VolumeHashListResponse.hash_list:type_name -> supervisor.v1.VolumeHash
	1,  // 38: supervisor.v1.Metric.type:type_name -> supervisor.v1.MetricType
	38, // 39: supervisor.v1.VolumeMetrics.metrics:type_name -> supervisor.v1.Metric
	38, // 40: supervisor.v1.NodeMetrics.metrics:type_name -> supervisor.v1.Metric
	40, // 41: supervisor.v1.MetricsResponse.volume_metrics:type_name -> supervisor.v1.VolumeMetrics
	41, // 42: supervisor.v1.MetricsResponse.node_metrics:type_name -> supervisor.v1.NodeMetrics
	43, // 43: supervisor.v1.SyncRegionsRequest.regions:type_name -> supervisor.v1.SyncRegion
	34, // 44: supervisor.v1.SyncRegionsRequest.sync_context:type_name -> supervisor.v1.SyncContext
	34, // 45: supervisor.v1.SyncRegionRequest.sync_context:type_name -> supervisor.v1.SyncContext
	3,  // 46: supervisor.v1.PrimaryDeploymentConfig.ReplicaAndLocation.opt_node_config:type_name -> supervisor.v1.NodeConfig
	8,  // 47: supervisor.v1.Supervisor.Status:input_type -> supervisor.v1.SupervisorStatusRequest
	10, // 48: supervisor.v1.Supervisor.ConfigurePrimary:input_type -> supervisor.v1.ConfigurePrimaryRequest
	12, // 49: supervisor.v1.Supervisor.DeconfigurePrimary:input_type -> supervisor.v1.DeconfigurePrimaryRequest
	14, // 50: supervisor.v1.Supervisor.ConfigureReplica:input_type -> supervisor.v1.ConfigureReplicaRequest
	16, // 51: supervisor.v1.Supervisor.DeconfigureReplica:input_type -> supervisor.v1.DeconfigureReplicaRequest
	18, // 52: supervisor.v1.Supervisor.DeleteDeployment:input_type -> supervisor.v1.DeleteDeploymentRequest
	20, // 53: supervisor.v1.Supervisor.ConfigurePresentation:input_type -> supervisor.v1.ConfigurePresentationRequest
	22, // 54: supervisor.v1.Supervisor.DeconfigurePresentation:input_type -> supervisor.v1.DeconfigurePresentationRequest
	24, // 55: supervisor.v1.Supervisor.SetConsumerCount:input_type -> supervisor.v1.SetConsumerCountRequest
	26, // 56: supervisor.v1.Supervisor.GetConsumerCount:input_type -> supervisor.v1.GetConsumerCountRequest
	28, // 57: supervisor.v1.Supervisor.DumpConfig:input_type -> supervisor.v1.DumpConfigRequest
	39, // 58: supervisor.v1.Supervisor.Metrics:input_type -> supervisor.v1.MetricsRequest
	53, // 59: supervisor.v1.Supervisor.ConfigGetBool:input_type -> common.v1.ConfigKey
	54, // 60: supervisor.v1.Supervisor.ConfigUpdateBool:input_type -> common.v1.ConfigBool
	55, // 61: supervisor.v1.Supervisor.ConfigListBool:input_type -> common.v1.ConfigListQuery
	53, // 62: supervisor.v1.Supervisor.ConfigGetString:input_type -> common.v1.ConfigKey
	56, // 63: supervisor.v1.Supervisor.ConfigUpdateString:input_type -> common.v1.ConfigString
	55, // 64: supervisor.v1.Supervisor.ConfigListString:input_type -> common.v1.ConfigListQuery
	53, // 65: supervisor.v1.Supervisor.ConfigGetUint32:input_type -> common.v1.ConfigKey
	57, // 66: supervisor.v1.Supervisor.ConfigUpdateUint32:input_type -> common.v1.ConfigUint32
	55, // 67: supervisor.v1.Supervisor.ConfigListUint32:input_type -> common.v1.ConfigListQuery
	53, // 68: supervisor.v1.Supervisor.ConfigGetUint64:input_type -> common.v1.ConfigKey
	58, // 69: supervisor.v1.Supervisor.ConfigUpdateUint64:input_type -> common.v1.ConfigUint64
	55, // 70: supervisor.v1.Supervisor.ConfigListUint64:input_type -> common.v1.ConfigListQuery
	44, // 71: supervisor.v1.Supervisor.SyncRegions:input_type -> supervisor.v1.SyncRegionsRequest
	46, // 72: supervisor.v1.Supervisor.Sync:input_type -> supervisor.v1.SyncRegionRequest
	36, // 73: supervisor.v1.Supervisor.VolumeHashList:input_type -> supervisor.v1.VolumeHashListRequest
	9,  // 74: supervisor.v1.Supervisor.Status:output_type -> supervisor.v1.SupervisorStatusResponse
	11, // 75: supervisor.v1.Supervisor.ConfigurePrimary:output_type -> supervisor.v1.ConfigurePrimaryResponse
	13, // 76: supervisor.v1.Supervisor.DeconfigurePrimary:output_type -> supervisor.v1.DeconfigurePrimaryResponse
	15, // 77: supervisor.v1.Supervisor.ConfigureReplica:output_type -> supervisor.v1.ConfigureReplicaResponse
	17, // 78: supervisor.v1.Supervisor.DeconfigureReplica:output_type -> supervisor.v1.DeconfigureReplicaResponse
	19, // 79: supervisor.v1.Supervisor.DeleteDeployment:output_type -> supervisor.v1.DeleteDeploymentResponse
	21, // 80: supervisor.v1.Supervisor.ConfigurePresentation:output_type -> supervisor.v1.ConfigurePresentationResponse
	23, // 81: supervisor.v1.Supervisor.DeconfigurePresentation:output_type -> supervisor.v1.DeconfigurePresentationResponse
	25, // 82: supervisor.v1.Supervisor.SetConsumerCount:output_type -> supervisor.v1.SetConsumerCountResponse
	27, // 83: supervisor.v1.Supervisor.GetConsumerCount:output_type -> supervisor.v1.GetConsumerCountResponse
	29, // 84: supervisor.v1.Supervisor.DumpConfig:output_type -> supervisor.v1.DumpConfigResponse
	42, // 85: supervisor.v1.Supervisor.Metrics:output_type -> supervisor.v1.MetricsResponse
	59, // 86: supervisor.v1.Supervisor.ConfigGetBool:output_type -> common.v1.ConfigGetBoolReply
	60, // 87: supervisor.v1.Supervisor.ConfigUpdateBool:output_type -> common.v1.ConfigUpdateReply
	61, // 88: supervisor.v1.Supervisor.ConfigListBool:output_type -> common.v1.ConfigBoolList
	62, // 89: supervisor.v1.Supervisor.ConfigGetString:output_type -> common.v1.ConfigGetStringReply
	60, // 90: supervisor.v1.Supervisor.ConfigUpdateString:output_type -> common.v1.ConfigUpdateReply
	63, // 91: supervisor.v1.Supervisor.ConfigListString:output_type -> common.v1.ConfigStringList
	64, // 92: supervisor.v1.Supervisor.ConfigGetUint32:output_type -> common.v1.ConfigGetUint32Reply
	60, // 93: supervisor.v1.Supervisor.ConfigUpdateUint32:output_type -> common.v1.ConfigUpdateReply
	65, // 94: supervisor.v1.Supervisor.ConfigListUint32:output_type -> common.v1.ConfigUint32List
	66, // 95: supervisor.v1.Supervisor.ConfigGetUint64:output_type -> common.v1.ConfigGetUint64Reply
	60, // 96: supervisor.v1.Supervisor.ConfigUpdateUint64:output_type -> common.v1.ConfigUpdateReply
	67, // 97: supervisor.v1.Supervisor.ConfigListUint64:output_type -> common.v1.ConfigUint64List
	45, // 98: supervisor.v1.Supervisor.SyncRegions:output_type -> supervisor.v1.SyncRegionsResponse
	47, // 99: supervisor.v1.Supervisor.Sync:output_type -> supervisor.v1.SyncRegionResponse
	37, // 100: supervisor.v1.Supervisor.VolumeHashList:output_type -> supervisor.v1.VolumeHashListResponse
...
func file_supervisor_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_supervisor_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReplicaDeploymentConfig); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_supervisor_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PrimaryDeploymentConfig); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_supervisor_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ConfigurePrimaryRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_supervisor_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ConfigurePrimaryResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_supervisor_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DeconfigurePrimaryRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_supervisor_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DeconfigurePrimaryResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_supervisor_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ConfigureReplicaRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_supervisor_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ConfigureReplicaResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_supervisor_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DeconfigureReplicaRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_supervisor_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DeconfigureReplicaResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_supervisor_proto_msgTypes[33].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*VolumeHashListRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_supervisor_proto_msgTypes[34].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*VolumeHashListResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_supervisor_proto_msgTypes[45].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PrimaryDeploymentConfig_ReplicaAndLocation); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_supervisor_proto_msgTypes[3].OneofWrappers = []interface{}{}
	file_supervisor_proto_msgTypes[45].OneofWrappers = []interface{}{}
	type x struct{}
...
type SupervisorClient interface {
	...
	// Creates a primary deployment. A primary deployment is differentiated from
	// a replica deployment in that it might have replicas. Like all
	// "Configure*" RPCs this method has "create if not present, else update"
	// semantics, i.e.:
	//
	//  - if no configuration exists for "uuid" we create the primary
	//  - if configuration exists for "uuid" then we apply any diffs.
	//
	// The only valid diffs are removal/addition of replicas, and changing
	// the cc. Once specified compression can not be modified.
	//
	// Under the hood this method creates the blob files into which we'll store
	// user data. Notice the replica configuration is present in the embedded
	// ReplicaDeploymentConfig field. There's no separate API to add or remove
	// these.
	//
	// Note: this RPC does not configure the replicas it merely tells the
	// primary about the existance and location of its replicas. To configure
	...
	// be set to false and rpc_result.code will be set to STATUS_*.
	// rpc_result.reason may be set.
	ConfigurePrimary(ctx context.Context, in *ConfigurePrimaryRequest, opts ...grpc.CallOption) (*ConfigurePrimaryResponse, error)
	// Deconfigure the primary. This lets the dataplane know that we are done
	...
	// specific code returned is STATUS_NOT_FOUND - this is set when the primary
	...
	// rpc_result.reason may be set.
	DeconfigurePrimary(ctx context.Context, in *DeconfigurePrimaryRequest, opts ...grpc.CallOption) (*DeconfigurePrimaryResponse, error)
	// Create a replica deployment. This is called on the node which is housing
	// the replica. Under the hood this method creates the blob files into which
	// we'll store user data. Like ConfigurePrimary this RPC brings the replica
	// into existence (i.e. creates the blob files) on the first call. All
	// subsequent calls simply load the blobs and make the deployment eligible
	// for access.
	//
	// On success rpc_result.success will be set to true. On failure it will
	// be set to false and rpc_result.code will be set to STATUS_*.
	// rpc_result.reason may be set.
	ConfigureReplica(ctx context.Context, in *ConfigureReplicaRequest, opts ...grpc.CallOption) (*ConfigureReplicaResponse, error)
	// Deconfigure the primary. This lets the dataplane know that we are done
	// with the deployment and allows the dataplane to release runtime resources
	// associated with the deployment. The CP would typically call this API when
	// a the volume is no longer in use or during a promote, where we'll
	// deconfigure a replica before making it a primary by calling
	// ConfigurePrimary.
	//
	// This RPC does not delete the block (meta)data associated with the
	// deployment. Call DeleteDeployment for that.
	...
	// On success rpc_result.success will be set to true. On failure it will
	// be set to false and rpc_result.code will be set accordingly. The only
	// specific code returned is STATUS_NOT_FOUND - this is set when the replica
	// you asked to deconfigure is not configured. For all other errors
	// rpc_result.code will be set to STATUS_*. In all failure case
	// rpc_result.reason may be set.
	DeconfigureReplica(ctx context.Context, in *DeconfigureReplicaRequest, opts ...grpc.CallOption) (*DeconfigureReplicaResponse, error)
	// Irrevocably delete the deployment (meta)data.
	//
	// The deployment must be deconfigured, either via DeconfigurePrimary or
	// DeconfigureReplica prior to calling this method, or we'll reject the
	...
	// on the primary deployment (we don't ever need to set the consumer count
	...
	// is implicitly transmitted to the dataplane by calling ConfigurePrimary. The
	// ConfigurePrimary request contains the consumer count.
	//
	// On success rpc_result.success will be set to true. On failure it will
	// be set to false and rpc_result.code will be set accordingly. The only
	// specific code returned is STATUS_NOT_FOUND - this is set when the
	// primary you asked to set the CC on doesn't even exist. For all other
	// errors rpc_result.code will be set to STATUS_*. In all failure case
	...
	//
	// WARNING: this API is removed as of release v2.5.0-ga. Use SyncRegions
	// instead. Unfortunately we have to keep the RPC here to avoid breaking
	// builds of the dataplane pre v2.5.0-ga. These builds use the service repo
	// branch origin/main rather than a specified commit/tag. If we remove this
	// RPC all of those builds break.
	//
	// We shouldn't hamstring ourselves with this problem indefinitely. At some
	// point we should bite the bullet and either:
	//
	// - retire origin/main and start a new branch origin/main2. All builds
	// pre 2.x use origin/main/ All builds post 2.x use origin/main2. Going
	// forward we ensure that the dataplane tracks an explicit commit in the
	// service repo.
	// - accept that we are going to break builds pre 2.x and make breaking
	// changes to origin/main. If we ever want to build pre 2.x we have to
	// manually set the service repo to the last commit in origin/main prior to
	// the breaking change.
	//
	// At various points we did pin the service repo to specific commits. In
	// general we haven't though. The following range of commits dates, are
	// pinned to origin/main, and thus would break if we removed this RPC:
	//
	// 98b1261 Aug 06 2021 to now (Oct 11 2021)
	// d3b2364 Nov 17 2020 to f19616e Dec 07 2020
	//
	// More discussion on DP-452.
...
func (c *supervisorClient) ConfigurePrimary(ctx context.Context, in *ConfigurePrimaryRequest, opts ...grpc.CallOption) (*ConfigurePrimaryResponse, error) {
	out := new(ConfigurePrimaryResponse)
	err := c.cc.Invoke(ctx, "/supervisor.v1.Supervisor/ConfigurePrimary", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *supervisorClient) DeconfigurePrimary(ctx context.Context, in *DeconfigurePrimaryRequest, opts ...grpc.CallOption) (*DeconfigurePrimaryResponse, error) {
	out := new(DeconfigurePrimaryResponse)
	err := c.cc.Invoke(ctx, "/supervisor.v1.Supervisor/DeconfigurePrimary", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *supervisorClient) ConfigureReplica(ctx context.Context, in *ConfigureReplicaRequest, opts ...grpc.CallOption) (*ConfigureReplicaResponse, error) {
	out := new(ConfigureReplicaResponse)
	err := c.cc.Invoke(ctx, "/supervisor.v1.Supervisor/ConfigureReplica", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *supervisorClient) DeconfigureReplica(ctx context.Context, in *DeconfigureReplicaRequest, opts ...grpc.CallOption) (*DeconfigureReplicaResponse, error) {
	out := new(DeconfigureReplicaResponse)
	err := c.cc.Invoke(ctx, "/supervisor.v1.Supervisor/DeconfigureReplica", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SupervisorServer interface {
	...
	// be set to false and rpc_result.code will be set to STATUS_*.
	// rpc_result.reason may be set.
	ConfigurePrimary(context.Context, *ConfigurePrimaryRequest) (*ConfigurePrimaryResponse, error)
	// Deconfigure the primary. This lets the dataplane know that we are done
	// with the deployment and allows the dataplane to release runtime resources
	// associated with the deployment. The CP would typically call this API when
	// a the volume is no longer in use.
	...
	// rpc_result.code will be set to STATUS_*. In all failure case
	// rpc_result.reason may be set.
	DeconfigurePrimary(context.Context, *DeconfigurePrimaryRequest) (*DeconfigurePrimaryResponse, error)
	// Create a replica deployment. This is called on the node which is housing
	// the replica. Under the hood this method creates the blob files into which
	// we'll store user data. Like ConfigurePrimary this RPC brings the replica
	// into existence (i.e. creates the blob files) on the first call. All
	...
	// be set to false and rpc_result.code will be set to STATUS_*.
	// rpc_result.reason may be set.
	ConfigureReplica(context.Context, *ConfigureReplicaRequest) (*ConfigureReplicaResponse, error)
	// Deconfigure the primary. This lets the dataplane know that we are done
	// with the deployment and allows the dataplane to release runtime resources
	// associated with the deployment. The CP would typically call this API when
	// a the volume is no longer in use or during a promote, where we'll
	...
	// rpc_result.code will be set to STATUS_*. In all failure case
	// rpc_result.reason may be set.
	DeconfigureReplica(context.Context, *DeconfigureReplicaRequest) (*DeconfigureReplicaResponse, error)
	// Irrevocably delete the deployment (meta)data.
	//
	// The deployment must be deconfigured, either via DeconfigurePrimary or
	// DeconfigureReplica prior to calling this method, or we'll reject the
...
func (*UnimplementedSupervisorServer) ConfigurePrimary(context.Context, *ConfigurePrimaryRequest) (*ConfigurePrimaryResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ConfigurePrimary not implemented")
}
func (*UnimplementedSupervisorServer) DeconfigurePrimary(context.Context, *DeconfigurePrimaryRequest) (*DeconfigurePrimaryResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeconfigurePrimary not implemented")
}
func (*UnimplementedSupervisorServer) ConfigureReplica(context.Context, *ConfigureReplicaRequest) (*ConfigureReplicaResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ConfigureReplica not implemented")
}
func (*UnimplementedSupervisorServer) DeconfigureReplica(context.Context, *DeconfigureReplicaRequest) (*DeconfigureReplicaResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeconfigureReplica not implemented")
}
...
func (*UnimplementedSupervisorServer) Sync(context.Context, *SyncRegionRequest) (*SyncRegionResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Sync not implemented")
}
func (*UnimplementedSupervisorServer) VolumeHashList(*VolumeHashListRequest, Supervisor_VolumeHashListServer) error {
...
func _Supervisor_ConfigurePrimary_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ConfigurePrimaryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SupervisorServer).ConfigurePrimary(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/supervisor.v1.Supervisor/ConfigurePrimary",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SupervisorServer).ConfigurePrimary(ctx, req.(*ConfigurePrimaryRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Supervisor_DeconfigurePrimary_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeconfigurePrimaryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SupervisorServer).DeconfigurePrimary(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/supervisor.v1.Supervisor/DeconfigurePrimary",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SupervisorServer).DeconfigurePrimary(ctx, req.(*DeconfigurePrimaryRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Supervisor_ConfigureReplica_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ConfigureReplicaRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SupervisorServer).ConfigureReplica(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/supervisor.v1.Supervisor/ConfigureReplica",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SupervisorServer).ConfigureReplica(ctx, req.(*ConfigureReplicaRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Supervisor_DeconfigureReplica_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeconfigureReplicaRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SupervisorServer).DeconfigureReplica(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/supervisor.v1.Supervisor/DeconfigureReplica",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SupervisorServer).DeconfigureReplica(ctx, req.(*DeconfigureReplicaRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Supervisor_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ConfigurePrimary",
			Handler:    _Supervisor_ConfigurePrimary_Handler,
		},
		{
			MethodName: "DeconfigurePrimary",
			Handler:    _Supervisor_DeconfigurePrimary_Handler,
		},
		{
			MethodName: "ConfigureReplica",
			Handler:    _Supervisor_ConfigureReplica_Handler,
		},
		{
			MethodName: "DeconfigureReplica",
			Handler:    _Supervisor_DeconfigureReplica_Handler,
		},
		{
